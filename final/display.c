...
{	/* a => A2 , b => A3 , c => A4 , d => A5 , e => A6 , f => A7 , g => B0 */
	...
	GPIO_PORTA_DATA_R = 0xFC | GPIO_PORTA_DATA_R; // 11111100
	GPIO_PORTB_DATA_R = 0x01 | GPIO_PORTB_DATA_R; // 00000001
	switch(digit1)
		{
		case '1': // A3 , A4
		...
		case '5': // A2 , A4 , A5 , A7 , B0
							GPIO_PORTA_DATA_R &= 0x4B; // 0100 1011
							GPIO_PORTB_DATA_R &= 0xFE; // 1111 1110
							break;
...
void displayOnSeg2(unsigned char digit2) {
    ...
    */
		...
		GPIO_PORTB_DATA_R = 0xFE | GPIO_PORTB_DATA_R;
    switch(digit2) {
        case '1': // B and C
...
{
	// a E0   -  b E1 - c	E2 - d	E3 - e	E4 - f	E5 - g	D6  
	// sagment is active low
	
	GPIO_PORTE_DATA_R = 0x3F | GPIO_PORTE_DATA_R;
	GPIO_PORTD_DATA_R = 0x40 | GPIO_PORTD_DATA_R;
	...
	switch (digit3)
	{
		...
		case '2' : // a , b , g , e , d low
			...
			GPIO_PORTD_DATA_R &= 0xBF ; // portD mask 1011 1111
			break;
		case '3' : // a , b , c , d , g
